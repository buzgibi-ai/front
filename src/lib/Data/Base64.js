...
export const encodeBase64Impl = function(buffer) {
...
export const decodeBase64Impl = function(just, nothing, str) {
    try {
        validateBase64(str);
...
export const fromStringImpl = function(just, nothing, str) {
    try {
        validateBase64(str);
        return just(str);
    } catch (e) {
